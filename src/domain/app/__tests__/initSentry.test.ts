...
describe('initSentry', () => {
  ...
  it('defaults Session Replay sample rates to 0 when unset', () => {
    vi.stubEnv('REACT_APP_SENTRY_DSN', 'https://example@sentry.io/1');
  ...
  it('defaults sample rates to 0 and trace propagation targets to an empty array when unset', () => {
    vi.stubEnv('REACT_APP_SENTRY_DSN', 'https://example@sentry.io/1');
  ...
  it('parses configured sample rates and trace propagation targets', () => {
    ...
    vi.stubEnv('REACT_APP_SENTRY_REPLAYS_SESSION_SAMPLE_RATE', '0.25');
    vi.stubEnv('REACT_APP_SENTRY_REPLAYS_ON_ERROR_SAMPLE_RATE', '0.5');
