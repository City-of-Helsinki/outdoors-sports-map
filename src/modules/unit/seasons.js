...
export const isBetweenDelimiters = (date: SeasonDelimiter, start: SeasonDelimiter, end: SeasonDelimiter): boolean => {
  ...
  const adjustedDate = { ...date, month: endBeforeStart && dateBeforeStart ? date.month + 12 : date.month };

  const adjustedEnd = { ...end, month: endBeforeStart ? end.month + 12 : end.month };
